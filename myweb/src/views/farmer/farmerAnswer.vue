...
<!--                <div class="tag">-->
<!--&lt;!&ndash;                  <el-tag :type="question.answer_count > 0 ? 'success' : 'warning'">&ndash;&gt;-->
<!--&lt;!&ndash;                    {{ question.answer_count > 0 ? '已回答' : '未回答' }}&ndash;&gt;-->
<!--&lt;!&ndash;                  </el-tag>&ndash;&gt;-->
<!--                  <el-tag-->
...
<!--                &lt;!&ndash; 回答表单 &ndash;&gt;-->
<!--                &lt;!&ndash;                <el-form @submit.prevent="submitAnswer" label-width="80px">&ndash;&gt;-->
<!--                &lt;!&ndash;                  <el-form-item label="回答">&ndash;&gt;-->
<!--                &lt;!&ndash;                    <el-input v-model="answerContent" type="textarea" :rows="4" placeholder="请输入回答"/>&ndash;&gt;-->
<!--                &lt;!&ndash;                  </el-form-item>&ndash;&gt;-->
<!--                &lt;!&ndash;                  <el-button type="primary" native-type="submit">提交</el-button>&ndash;&gt;-->
<!--                &lt;!&ndash;                  <el-button @click="$router.back()">取消</el-button>&ndash;&gt;-->
<!--                &lt;!&ndash;                </el-form>&ndash;&gt;-->
<!--              </div>-->
<!--            </el-card>-->
<!--            &lt;!&ndash; 回答列表 &ndash;&gt;-->
...
<!--&lt;!&ndash;                <div class="answer-footer">&ndash;&gt;-->
<!--&lt;!&ndash;&lt;!&ndash;                  <el-button type="text" icon="el-icon-thumb">{{ answer.upvotes || 0 }} 有用</el-button>&ndash;&gt;&ndash;&gt;-->
<!--&lt;!&ndash;                  <el-button&ndash;&gt;-->
<!--&lt;!&ndash;                      v-if="question.user_id === userStore.userId"&ndash;&gt;-->
<!--&lt;!&ndash;                      type="text"&ndash;&gt;-->
<!--&lt;!&ndash;                      icon="el-icon-delete"&ndash;&gt;-->
<!--&lt;!&ndash;                      @click="deleteAnswer(answer.answer_id)"            style="color: #f56c6c; margin-left: 10px;"&ndash;&gt;-->
<!--&lt;!&ndash;                  >&ndash;&gt;-->
<!--&lt;!&ndash;                    删除&ndash;&gt;-->
<!--&lt;!&ndash;                  </el-button>&ndash;&gt;-->
<!--&lt;!&ndash;                </div>&ndash;&gt;-->
