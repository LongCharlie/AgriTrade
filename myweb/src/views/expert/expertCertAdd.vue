...
<!--  <div>-->
<!--    <el-container>-->
<!--&lt;!&ndash;      <el-aside width="0px">&ndash;&gt;-->
<!--&lt;!&ndash;        <expert-common-aside></expert-common-aside>&ndash;&gt;-->
<!--&lt;!&ndash;      </el-aside>&ndash;&gt;-->
<!--      <el-container>-->
<!--&lt;!&ndash;        <el-header>&ndash;&gt;-->
<!--&lt;!&ndash;          <expert-common-header></expert-common-header>&ndash;&gt;-->
<!--&lt;!&ndash;        </el-header>&ndash;&gt;-->
<!--        <el-main>-->
...
<!--                    </div>-->
<!--&lt;!&ndash;                    <el-icon v-if="fileList.length === 0"><Plus /></el-icon>&ndash;&gt;-->
<!--&lt;!&ndash;                    <div v-if="fileList.length === 0" class="el-upload__text">&ndash;&gt;-->
<!--&lt;!&ndash;                      点击上传图片 <br/>&ndash;&gt;-->
<!--&lt;!&ndash;                      <span style="font-size: 12px; color: #999;">支持jpg/png格式，不超过5MB</span>&ndash;&gt;-->
<!--&lt;!&ndash;                    </div>&ndash;&gt;-->
<!--                  </el-upload>-->
                ...
                <el-form-item label="证书图片" prop="certificate_image">
                  <el-upload
                    ...
                    <div class="upload-content">
                      ...
                      <div class="upload-text">{{ hasImage ? '更换图片' : '点击上传图片' }}</div>
...
export default {
  ...
  computed: {
    hasImage() {
      return this.fileList.length > 0 || this.certificateImageUrl;
    }
  },
  created() {
    // 检查是否是编辑模式
