...
<!--    <h2>专家排行榜</h2>-->
<!--    &lt;!&ndash; 折线图有问题 &ndash;&gt;-->
<!--&lt;!&ndash;    <bar-chart :data="chartData" style="height: 400px; width: 100%;" />&ndash;&gt;-->
...
<!--&lt;!&ndash;      &lt;!&ndash; 职称 &ndash;&gt;&ndash;&gt;-->
<!--&lt;!&ndash;      <el-table-column prop="title" label="职称" align="center" />&ndash;&gt;-->
...
<template>
  <div class="expert-rank-container">
    ...
    <el-table :data="filteredRankList" style="width: 100%" :default-sort="{ prop: 'answer_count', order: 'descending' }">
      <!-- 排名 -->
      <el-table-column label="排名" width="80" align="center">
        <template #default="scope">
          <span :class="['rank-number', { 'top-three': scope.$index < 3 }]">
