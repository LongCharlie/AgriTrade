...
-- ----------------------------
-- Records of experience_comments
-- ----------------------------
...
CREATE TABLE `planting_records`  (
  ...
  `city` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '种植城市',
...
CREATE TABLE `price_references`  (
  ...
  UNIQUE INDEX `product_location_idx`(`product_name`, `province`, `city`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `purchase_applications`  (
  ...
  `city` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '供货城市',
...
-- ----------------------------
-- Records of purchase_applications
-- ----------------------------
...
CREATE TABLE `purchase_demands`  (
  ...
  `delivery_city` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '收货城市',
  ...
  INDEX `buyer_id`(`buyer_id`) USING BTREE,
  INDEX `city_status_idx`(`delivery_city`, `status`) USING BTREE,
